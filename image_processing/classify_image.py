from image_processing.image_utils import extract_non_background_mean_color, create_mask_from_polygon, get_polygon_coords, create_crop_image_matrix
...
def cluster_image(num_clusters, features, images, image_path, c_path):
    # This function will cluster the object by their HSV value 
    # This means that the image that have nearly same color value range will group into a class
...
def seperate_img_by_class(src_image, dest):
    # This function will rename the image based on their class with the corresponding index
...
def classify_color(image_path):
    # This function will classify the crop image based on HSV value -> filtering 'blacking' object
...
def seperate_img_by_BLACK(src_image, dest):
    # Seperate image by black and red to their corresponding folder
