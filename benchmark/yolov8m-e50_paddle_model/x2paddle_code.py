...
class DetectionModel(paddle.nn.Layer):
    def __init__(self):
        ...
        self.x635 = self.create_parameter(dtype='float32', shape=(1, 13125), default_initializer=paddle.nn.initializer.Constant(value=0.0))
        ...
        self.x854 = self.create_parameter(dtype='float32', shape=(1, 2, 13125), default_initializer=paddle.nn.initializer.Constant(value=0.0))
    ...
    def forward(self, x0):
        ...
        x839, x840 = x838
        x843 = paddle.reshape(x=x839, shape=[1, 4, 16, 13125])
        ...
        x853 = paddle.reshape(x=x851, shape=[1, 4, 13125])
        x854 = self.x854
...
def main(x0):
    # There are 1 inputs.
    # x0: shape-[1, 3, 800, 800], type-float32.
    paddle.disable_static()
    params = paddle.load(r'/home/topaci/Documents/thesis/sandbox/yolov8m-e50_paddle_model/model.pdparams')
